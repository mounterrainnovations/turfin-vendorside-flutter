...
class Step4KycDocuments extends ConsumerWidget {
  const Step4KycDocuments({super.key});
      ...
      child: Column(
        ...
        children: [
          ...
          _DocUploadTile(
            ...
            isRequired: true,
            filePath: s.aadharPath,
            onTap: () async {
              final path = await _pickImage(context);
              if (path != null) notifier.setAadhar(path);
            },
            tc: tc,
          ),
          ...
          _DocUploadTile(
            ...
            description: 'Certificate of incorporation or GST certificate',
            isRequired: false,
            filePath: s.companyRegPath,
            onTap: () async {
              final path = await _pickImage(context);
              if (path != null) notifier.setCompanyReg(path);
            },
            tc: tc,
          ),
          ...
          Container(
            ...
            child: Row(
              children: [
                Icon(Icons.info_outline_rounded, color: tc.onSurface30, size: 16),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: _hasFile ? _UploadedState(filePath: filePath!, label: label, tc: tc) : _EmptyState(label: label, description: description, isRequired: isRequired, tc: tc),
      ),
    );
  }
}
        ...
        ClipRRect(
          ...
          child: Image.file(
            ...
            errorBuilder: (_, __, ___) => Container(
              ...
              height: 64,
              color: tc.onSurface10,
              child: Icon(Icons.insert_drive_file_outlined, color: tc.onSurface30, size: 28),
            ),
          ),
        ),
